...
class LinkedInCarouselGenerator:
    ...
    def generate_demo(self):
        # Slide 1: Hook
        self.create_slide("Wenn das Licht ausgeht...", "Die juristischen Probleme fangen erst an.\nKRITIS & Blackouts 2026.")
        
        # Slide 2: Problem
        self.create_slide("Die Rechtslage", "Haftungsketten bei Stromausfall sind unklar.\nWer zahlt, wenn die Charité dunkel bleibt?")
        
        # Slide 3: Solution/Firm Pitch
        self.create_slide("Wir lösen das.", "Unsere Energy-Practice berät genau an dieser Schnittstelle von Technik & Recht.")
        
        # Slide 4: CTA
        self.create_slide("Komm ins Team!", "Du willst strategisch denken?\nWir suchen Associates in Berlin.\n\nLink in Bio.", footer_text="Apply Now")
        
        self.c.save()
        print(f"Carousel generated.")
